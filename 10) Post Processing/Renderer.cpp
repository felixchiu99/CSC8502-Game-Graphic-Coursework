...
Renderer::Renderer(Window & parent) : OGLRenderer(parent) {
	camera[0] = new Camera(-25.0f, 225.0f,
		Vector3(-150.0f, 250.0f, -150.0f));
	camera[1] = new Camera(-25.0f, 225.0f,
		Vector3());
	camera[2] = new Camera(-25.0f, 225.0f,
		Vector3(-150.0f, 250.0f, -150.0f));
	camera[3] = new Camera(-25.0f, 225.0f,
		Vector3(-150.0f, 250.0f, -150.0f));
